...
// Apart from routing folder and file conventions, Next.js is unopinionated about 
// how you organize and colocate your project files.
...
// However, even though route structure is defined through folders, a route is not 
// publicly accessible until a page.js or route.js file is added to a route segment.

// A diagram showing how a route is not publicly accessible until a page.js or 
// route.js file is added to a route segment.
// And, even when a route is made publicly accessible, only the content returned 
// by page.js or route.js is sent to the client.

// A diagram showing how page.js and route.js files make routes publicly accessible.
// This means that project files can be safely colocated inside route segments in 
// the app directory without accidentally being routable.

// A diagram showing colocated project files are not routable even when a segment 
// contains a page.js or route.js file.
// Good to know:

// This is different from the pages directory, where any file in pages is considered a route.
// While you can colocate your project files in app you don't have to. If you prefer, 
// you can keep them outside the app directory.

// Project organization features
// Next.js provides several features to help you organize your project.

// Private Folders
// Private folders can be created by prefixing a folder with 
// an underscore: _folderName

// This indicates the folder is a private implementation detail and should not 
// be considered by the routing system, thereby opting the folder and all its 
...
// While not a framework convention, you might also consider marking files outside 
// private folders as "private" using the same underscore pattern.
// You can create URL segments that start with an underscore by prefixing the folder 
// name with %5F (the URL-encoded form of an underscore): %5FfolderName.
// If you don't use private folders, it would be helpful to know Next.js special 
// file conventions to prevent unexpected naming conflicts.
...
// src directory. This separates application code from project configuration files
...
// and folders in a Next.js project.
...
// Good to know: In our examples below, we're using components and lib folders as 
// generalized placeholders, their naming has no special framework significance 
// and your projects might use other folders like ui, utils, hooks, styles, etc.
...
// and splits more specific application code into the route segments that use them.
