...
// Good to know: Route Handlers are only available inside the app directory. They are
//  the equivalent of API Routes inside the pages directory meaning you do not need 
// to use API Routes and Route Handlers together.
...
// Route Handlers can be nested inside the app directory, similar to page.js and 
// layout.js. But there cannot be a route.js file at the same route segment level 
// as page.js.

// Supported HTTP Methods
// The following HTTP methods are supported: GET, POST, PUT, PATCH, DELETE, HEAD,
//  and OPTIONS. If an unsupported method is called, Next.js will return a 405
...
// TypeScript Warning: Response.json() is only valid from TypeScript 5.2. If you 
// use a lower TypeScript version, you can use NextResponse.json() for typed
//  responses instead.
...
// Good to know: Like API Routes, Route Handlers can be used for cases like handling 
// form submissions. A new abstraction for handling forms and mutations that 
...
// Cookies
// You can read or set cookies with cookies from next/headers. This server function 
// can be called directly in a Route Handler, or nested inside of another function.
...
// Headers
// You can read headers with headers from next/headers. This server function can be 
// called directly in a Route Handler, or nested inside of another function.
...
// has some additional convenience methods, including for more easily handling 
// query parameters.
...
//  such as OpenAI, for AI-generated content. Learn more about the AI SDK.
...
// validate the request and retrieve data in the format you prefer (e.g. number).

// CORS
// You can set CORS headers for a specific Route Handler using the standard Web 
// API methods:
...
// To add CORS headers to multiple Route Handlers, you can use Middleware or 
...
// the same route segment configuration as Pages and Layouts, they support 
// long-awaited features like general-purpose statically regenerated Route Handlers.
