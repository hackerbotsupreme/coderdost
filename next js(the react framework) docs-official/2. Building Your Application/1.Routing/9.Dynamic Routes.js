...
// The primary benefit of the generateStaticParams function is its smart retrieval 
// of data. If content is fetched within the generateStaticParams function using 
// a fetch request, the requests are automatically memoized. This means a fetch 
// request with the same arguments across multiple generateStaticParams, Layouts,
//  and Pages will only be made once, which decreases build times.
