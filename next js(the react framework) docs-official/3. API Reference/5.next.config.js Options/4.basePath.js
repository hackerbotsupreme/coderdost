...
// use /docs instead of '' (an empty string, the default), open next.config.js and 
// add the basePath config:
...
// Links
// When linking to other pages using next/link and next/router the basePath will be 
// automatically applied.

// For example, using /about will automatically 
// become /docs/about when basePath is set to /docs.
