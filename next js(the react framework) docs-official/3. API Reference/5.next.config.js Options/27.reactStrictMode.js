...
//  so the above configuration is only necessary for pages. You can still disable 
...
// React's Strict Mode is a development mode only feature for highlighting potential 
// problems in an application. It helps to identify unsafe lifecycles, legacy API 
// usage, and a number of other features.

// The Next.js runtime is Strict Mode-compliant. To opt-in to Strict Mode, configure
//  the following option in your next.config.js:
