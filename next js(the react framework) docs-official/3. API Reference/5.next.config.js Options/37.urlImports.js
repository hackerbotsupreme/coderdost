...
// download and execute on your machine. Please exercise discretion, and 
...
// imports to execute in the browser sandbox using the Edge Runtime.

// Lockfile
// When using URL imports, Next.js will create a next.lock directory containing 
// a lockfile and fetched assets. This directory must be committed to Git, not 
...
// the build to fail. One exception is resources that respond with Cache-Control: 
// no-cache. These resources will have a no-cache entry in the lockfile and will 
// always be fetched from the network on each build.
